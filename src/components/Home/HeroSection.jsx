    ...
    return (
        <div className={styles.hero}>
            <div className={styles.hero__content}>
                ...
                <div>
                    <p className={styles.hero__body}>We are a family owned cozy restaurant, focused on traditional
                        recipes served with a modern twist.</p>
                </div>
                <div className={styles.hero__button}><ButtonLarge text="Reserve a Table" href="/reservations" aria="button reserve a table"/></div>
            </div>
