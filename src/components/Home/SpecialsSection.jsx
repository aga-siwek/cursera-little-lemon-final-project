...
export default function SpecialsSection ({specials}) {
    console.log("my dishes special in special")
    ...
    return (
        <div className={styles.specials}>
            ...
            <div className={styles.specials__cards}>
                {specials.map((special, index) => <ProductCard key={index} title={special.title} price={special.price} body={special.body} href={special.href} image_name={special.image_name}/>)}
            </div>
